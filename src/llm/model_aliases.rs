...
impl ModelResolver {
    pub fn new() -> Self {
        ...
        // GPT-5 variants (coming August 2025)
        ...
        aliases.insert(
            ...
            "anthropic/claude-instant-1.2".to_string(),
        );
        aliases.insert(
            "instant".to_string(),
            "anthropic/claude-instant-1.2".to_string(),
        ...
        aliases.insert(
            ...
            "anthropic/claude-4-opus".to_string(),
        );
        aliases.insert(
            "sonnet-4".to_string(),
            "anthropic/claude-4-sonnet".to_string(),
    ...
    pub fn resolve(&self, input: &str) -> String {
        ...
        if without_date != input {
            ...
            let normalized_without_date = without_date
                .to_lowercase()
                .replace('-', "")
                .replace('_', "")
                .replace(' ', "");
